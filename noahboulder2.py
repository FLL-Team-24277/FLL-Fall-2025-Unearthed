...
def Run(br: BaseRobot):
    ...
    br.moveLeftAttachmentMotorForMillis(millis=350, speedPct=40, waiting=False)
    ...
    br.moveLeftAttachmentMotorForMillis(millis=900, speedPct=-80)
    # br.driveForDistance(distance=100, speedPct=80, then=Stop.BRAKE, waiting=True)
    br.moveRightAttachmentMotorForMillis(millis=200, speedPct=-40)
    # br.driveForDistance(distance=-100, speedPct=80, then=Stop.BRAKE, waiting=True)
